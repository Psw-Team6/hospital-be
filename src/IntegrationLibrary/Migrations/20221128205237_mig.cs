    ...
    public partial class mig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2708b8d4-99c0-44dd-b0d1-d60543c7a201"), "x", "aas@gmail.com", "BloodBank", "VNEXwZIHrujyvlg0wnmHM2FkQ52BKSkUTv5Gobgj4MeeAADy", "localhost" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("fc7fa009-af6a-47df-8336-b55616a05f02"), 10.0, "", new DateTime(2022, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ilija", "Operacija", 2, 5 },
                    { new Guid("d46cb553-059b-4317-b08c-607bba77bd1f"), 20.0, "", new DateTime(2022, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ilija", "Transfuzija", 2, 3 },
                    { new Guid("2c1f8507-6019-4a54-a78b-28fb5ca51fd1"), 20.0, "", new DateTime(2023, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ilija", "Transfuzija", 2, 0 },
                    { new Guid("427b9ff8-8b97-4d42-ae59-6f98d195e02a"), 5.0, "", new DateTime(2023, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ilija", "Zalihe", 2, 6 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d2b26c9c-0f2c-44c5-a2a3-32ce90deb7c6"), "Moja Banka Krvi", "ONE_MONTH", new DateTime(2022, 11, 28, 21, 52, 36, 12, DateTimeKind.Local).AddTicks(6873), "EVERY_TWO_MINUT" },
                    { new Guid("0e0ca636-fc9a-4bde-80f1-e2125e7931d0"), "Nova banka", "TWO_MONTH", new DateTime(2022, 11, 28, 21, 52, 36, 17, DateTimeKind.Local).AddTicks(9407), "ONE_MONTH" }
                });
        }
