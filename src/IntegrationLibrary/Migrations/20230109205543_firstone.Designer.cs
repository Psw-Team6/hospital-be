...
namespace IntegrationLibrary.Migrations
{
    ...
    [Migration("20230109205543_firstone")]
            ...
            modelBuilder.Entity("IntegrationLibrary.BloodBank.BloodBank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f94a1824-1e6a-42f8-89d5-b9ac3ae47f20"),
                            Email = "aas@gmail.com",
                            Name = "BloodBank",
            ...
            modelBuilder.Entity("IntegrationLibrary.BloodRequests.Model.BloodRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5805c5f0-d755-4f87-a92f-5b6cbb895439"),
                            Amount = 10.0,
                        ...
                        new
                        {
                            Id = new Guid("78028f77-7852-42a9-9972-1bf5bda85d57"),
                            Amount = 20.0,
                            BloodBankId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Comment = "",
                        ...
                        new
                        {
                            Id = new Guid("6dbc8675-a43b-4194-a6c1-0db13a2aa6cb"),
                            Amount = 20.0,
                            BloodBankId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Comment = "",
                        ...
                        new
                        {
                            Id = new Guid("fcd5ad92-e250-4561-ab1f-8ca860aeb09e"),
                            Amount = 5.0,
                            BloodBankId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Comment = "",
                            Date = new DateTime(2023, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("IntegrationLibrary.ConfigureGenerateAndSend.Model.ConfigureGenerateAndSend", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a8bea6a-c73d-47e3-a11b-24dc5929c32d"),
                            BloodBankName = "Moja Banka Krvi",
                            GeneratePeriod = "ONE_MONTH",
                            NextDateForSending = new DateTime(2023, 1, 9, 21, 55, 43, 281, DateTimeKind.Local).AddTicks(1718),
                            SendPeriod = "EVERY_TWO_MINUT"
                        },
                        new
                        {
                            Id = new Guid("d666e43c-3a43-4e50-aa7a-e62d9acf2dec"),
                            BloodBankName = "Nova banka",
                            GeneratePeriod = "TWO_MONTH",
                            NextDateForSending = new DateTime(2023, 1, 9, 21, 55, 43, 291, DateTimeKind.Local).AddTicks(9969),
            ...
            modelBuilder.Entity("IntegrationLibrary.Tender.Model.BloodUnitAmount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9cfd69d2-8d31-4198-963a-96018b322d5d"),
                            Amount = 10,
                            BloodType = 0,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("b7a3c9fb-5c08-43ca-b94f-59b1e3000af1"),
                            Amount = 0,
                            BloodType = 1,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("ba62ab0b-1462-481d-b9e4-10247c629ad8"),
                            Amount = 5,
                            BloodType = 2,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("5c29015c-a0d4-47bf-aaad-410d73ca57e5"),
                            Amount = 0,
                            BloodType = 3,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("ac36e432-f531-492c-b267-9bf71bfff199"),
                            Amount = 12,
                            BloodType = 4,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("531ec062-8818-4651-8bda-e5a08a7c2fa7"),
                            Amount = 7,
                            BloodType = 5,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("ed3570d4-51a9-4e8e-8f32-44da70729602"),
                            Amount = 10,
                            BloodType = 6,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("72dde8c1-2101-419a-8e0e-a0aad5d5c52d"),
                            Amount = 0,
                            BloodType = 7,
                            TenderId = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7")
                        },
                        new
                        {
                            Id = new Guid("5f915480-5098-4ef3-9d30-6bd48d00ef47"),
                            Amount = 7,
                            BloodType = 5,
                            TenderId = new Guid("8da00c33-39b0-453b-ae26-f03e09e234d4")
                        },
                        new
                        {
                            Id = new Guid("5107a6fb-0149-4ce1-a7d6-4524958be89c"),
                            Amount = 10,
                            BloodType = 6,
                            TenderId = new Guid("8da00c33-39b0-453b-ae26-f03e09e234d4")
                        },
                        new
                        {
                            Id = new Guid("64cd89b7-570e-4ea9-93dd-f347a71fdc38"),
                            Amount = 0,
                            BloodType = 7,
                            TenderId = new Guid("8da00c33-39b0-453b-ae26-f03e09e234d4")
                        });
            ...
            modelBuilder.Entity("IntegrationLibrary.Tender.Model.Tender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a194651-844c-41c1-acdc-bd4ce478dbb7"),
                            DeadlineDate = new DateTime(2023, 1, 29, 21, 55, 43, 292, DateTimeKind.Local).AddTicks(2143),
                            HasDeadline = true,
                            PublishedDate = new DateTime(2023, 1, 9, 21, 55, 43, 292, DateTimeKind.Local).AddTicks(2577),
                            Status = 0
                        },
                        new
                        {
                            Id = new Guid("8da00c33-39b0-453b-ae26-f03e09e234d4"),
                            DeadlineDate = new DateTime(2023, 1, 8, 21, 55, 43, 292, DateTimeKind.Local).AddTicks(4054),
                            HasDeadline = true,
                            PublishedDate = new DateTime(2023, 1, 5, 21, 55, 43, 292, DateTimeKind.Local).AddTicks(4086),
                            Status = 2
                        });
                });
                    ...
                    b.OwnsOne("IntegrationLibrary.BloodBank.Model.ApiKey", "ApiKey", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    BloodBankId = new Guid("f94a1824-1e6a-42f8-89d5-b9ac3ae47f20"),
                                    Value = "h+vLNKbrWu+bpT5I1/e12asBn1KvUf2735y9DHmUxCA="
                                });
                        });
