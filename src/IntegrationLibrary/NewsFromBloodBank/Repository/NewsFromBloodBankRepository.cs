...
namespace IntegrationLibrary.NewsFromBloodBank.Repository
{
    public class NewsFromBloodBankRepository : INewsFromBloodBankRepository
    {
        ...
        public IEnumerable<NewsFromBloodBank.Model.NewsFromBloodBank> GetAllPatientNews()
        {
            return _context.NewsFromBloodBank.Where(newFromBloodBank => newFromBloodBank.newsStatus == NewsFromHospitalStatus.ACTIVE);
        }
