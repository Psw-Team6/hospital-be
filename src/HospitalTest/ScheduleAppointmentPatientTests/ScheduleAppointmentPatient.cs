...
namespace HospitalTest.ScheduleAppointmentPatientTests
{
    public class ScheduleAppointmentPatient
    {
        [Fact]
        public async Task Schedule_appointment_doctor_with_specialisation_doesnt_exist()
        {
        ...
        [Fact]
        public async Task Schedule_appointment_date_range_not_valid()
        {
            var mockDoctorRepo = new Mock<IDoctorRepository>();
            var mockUnitOfWork = new Mock<IUnitOfWork>();
        ...
        [Fact]
        public async Task Schedule_appointment_date_range_has_pased()
        {
            var mockDoctorRepo = new Mock<IDoctorRepository>();
            var mockUnitOfWork = new Mock<IUnitOfWork>();
        ...
        [Fact]
        public async Task Schedule_appointment_no_free_appointments()
        {
            DateRange Duration = new DateRange
            {
            ...
            var doctor = CreateMockScheduleNoFreeeAppointments(out var doctorService);
        ...
        private static Doctor CreateMockScheduleAppointmentValid(out DoctorService doctorService)
        {
            var mockDoctorRepo = new Mock<IDoctorRepository>();
        ...
        private static Doctor CreateMockScheduleNoFreeeAppointments(out DoctorService doctorService)
        {
            var mockDoctorRepo = new Mock<IDoctorRepository>();
            var mockAppointmentRepo = new Mock<IAppointmentRepository>();
            var mockHolidayRepo = new Mock<IHolidayRepository>();
